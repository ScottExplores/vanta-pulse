import { authorLevel } from "./builders";
...
export const GLASS_HORIZON = authorLevel({
  ...
  threats: [
    { beat: 4, kind: "spike" },
    { beat: 8, kind: "spike" },
    { beat: 12, kind: "gap", width: 144 },
    { beat: 16, kind: "double-spike" },
    { beat: 19, kind: "pulse-gate", height: 68 },
    { beat: 22, kind: "gap", width: 168 },
    { beat: 24, kind: "spike" },
    { beat: 26, kind: "double-spike" },
    { beat: 28, kind: "pulse-gate" },
  ],
  bonusPrisms: [
    { beat: 1, y: 18 },
    { beat: 2, y: 18 },
